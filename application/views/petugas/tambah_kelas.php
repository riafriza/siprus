              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" name="random_form" action="<?php echo base_url('admin/kelas/insert_kelas');?>" method="POST">
                      <div class="box-body">
                        <div class="form-group">
                          <label for="exampleInputNama1">Nama Kelas</label>
                          <input type="text" name="kelas" class="form-control" id="exampleInputKode1" placeholder="Contoh : 1A">
                        </div>
                      </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- form start -->
                      <div class="box-body">
                        <div class="form-group">
                          <label for="exampleInputKeterangan1">Jurusan</label>
                          <select class="form-control" required name="id_jurusan">
                            <option value="" disabled diselected>-- Pilih Jurusan --</option>
                              <?php                                
