              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" name="random_form" action="<?php echo base_url('admin/pengarang/insert_pengarang');?>" method="POST">
                      <div class="box-body">
                        <div class="form-group">
                          <label for="exampleInputNama1">Nama</label>
                          <input type="text" name="nama_pengarang" class="form-control" id="exampleInputNama1" placeholder="Contoh : Aldi">
                        </div>
                        <div class="form-group">
