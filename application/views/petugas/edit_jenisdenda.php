              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" name="random_form" action="<?php echo base_url('admin/jenisdenda/update_jenisdenda');?>" method="POST">
                    <?php foreach($denda as $den) : ?>
                      <div class="box-body">
                       <div class="form-group">
                       <input type="hidden" name="id_denda" class="form-control" value="<?php echo $den->id_denda;?>">
                ...
                <div class="col-md-6">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- form start -->
                      <div class="box-body">
                          <div class="form-group">
                            <label for="exampleInputNama1">Jumlah</label>
                            <input type="number" name="jumlah" class="form-control" id="exampleInputKode1" placeholder="Contoh : 2000" value="<?php echo $den->jumlah;?>">
                          </div>
                        </div>
                      </div>
                <?php endforeach;?>
