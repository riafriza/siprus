                          ...
                          <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                              ...
                              <li><a href="#tab_3" data-toggle="tab">Kehilangan / Kerusakan</a></li>
                               <li><a href="#tab_4" data-toggle="tab">Pengganti Kehilangan / Kerusakan</a></li>
                            </ul>
                              <div class="tab-content">
                                      ...
                                      <tr>
                                        ...
                                        <th>Denda</th>
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              <td><?php echo $no++;?></td>
                                              <td><?php echo $kem->nim.' '.$kem->nama;?></td>
                                      ...
                                      <tr>
                                        ...
                                        <th>Keterangan</th>
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              <td><?php echo $no++;?></td>
                                              <td><?php echo $ker->nim.' '.$ker->nama;?></td>
                                ...
                                <div class="tab-pane" id="tab_4">
                                  <div class="form-group">                       
                                      <a href="#">
                                        <button id="export_pengganti" type="button" class="btn btn-normal btn-success">Export Pengganti</button>
                                      </a>                                       
                                  </div>
                                  <div class="box-body">
                                    <table id="example4" class="table table-bordered table-hover pengganti">
                                      <thead>
                                      <tr>
                                        <th>No</th>
                                        <th>Anggota</th>
                                        ...
                                        <th>Keterangan</th>
                                          ...
                                          <tbody>
                                            <?php 
                                            $no=1;
                                            foreach($pengganti as $ker): ?>
                                            <tr>
                                              <td><?php echo $no++;?></td>
                                              <td><?php echo $ker->nim.' '.$ker->nama;?></td>
                                              <td><?php echo $ker->judul;?></td>
                                              <td><?php echo $ker->kode_eksemplar;?></td>
                                              <td><?php echo $ker->nama_barang;?></td>
                                              <td><?php echo $ker->jumlah;?></td>
                                              <td><?php echo $ker->tgl_pengganti;?></td>
                                              <td><?php echo $ker->keterangan_ganti;?></td>
                                            </tr>
                                          <?php endforeach;?>
                                          </tbody>
                                    </table>
