...
class Pengarang extends CI_Controller {
	...
	public function update_pengarang() {
		...
		if ($cek > 0) {
			$this->session->set_flashdata('data', 'Data sudah ada sebelumnya');
			redirect(site_url('petugas/pengarang'));
		} else {
