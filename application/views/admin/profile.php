          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              ...
              <?php foreach ($profil as $pro) :?>
                  <form action="<?php echo base_url('admin/profile/update_profile');?>" method="POST">
                    ...
                    <div class="form-group">
                        <label for="exampleInputNim1">No HP</label>
                        <input type="text" name="no_hp" class="form-control" id="exampleInputNim1" value="<?php echo $pro->no_hp;?>">
                    </div>
                                  ...
                                  <!-- konten modal-->
                                    ...
                                    <!-- body modal -->
                                      <div class="modal-body">
                                        <form role="form" action="<?php echo base_url('admin/profile/insert_password');?>" method="POST">
                                          <div class="form-group">
                                              <input type="hidden" name="id_admin" class="form-control" value="<?php echo $pro->id_admin;?>">
