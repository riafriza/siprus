  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!--grafik akan ditampilkan disini -->
        <h3 class="active">Peminjaman</h3>
        <div id="peminjaman" style="height:200px;"></div>
        <h3 class="active">Pengembalian</h3>
        <div id="pengembalian" style="height:200px;"></div>

        <script src="<?php echo base_url();?>assets/jquery.min.js"></script>
        <script src="<?php echo base_url();?>assets/konten/bower_components/raphael/raphael.js"></script>
        <script src="<?php echo base_url();?>assets/konten/bower_components/morris/morris.js"></script>
        <script>
            Morris.Area({
              element: 'peminjaman',
              data: <?php echo $grafpem;?>,
              xkey: 'tgl_pinjam',
              ykeys: ['buku'],
              labels: ['Buku']
            });
             Morris.Area({
              ...
              data: <?php echo $grafpeng;?>,
              xkey: 'tgl_dikembalikan',
              ykeys: ['buku'],
              labels: ['Buku']
            });
        </script>
