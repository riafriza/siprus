  ...
  <div class="content-wrapper">
                    ...
                    <div class="box-header with-border">
                      <h3 class="box-title">Mulai Sirkulasi</h3>
                       ...
                       <div class="box-tools pull-right">
                          <a href="<?php echo base_url('admin/sirkulasi/hapus');?>"><button type="button" class="btn btn-danger"><i class="fa fa-remove"></i></button></a>
                        </div>
                    </div>
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              <div class="tab-content">
                                <div class="tab-pane active" id="tab_1">
                                  <form action="<?php echo base_url('admin/sirkulasi/insert_pinjam');?>" method="POST">
                                        ...
                                        <th>Aksi</th>
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                <a href="<?php echo base_url('admin/sirkulasi/delete_peminjaman/'.$pem->id_pinjam);?>"><button type="button" class="btn btn-danger" onClick="return confirm('Apakah anda yakin ingin menghapus data ini.?')"><i class="fa fa-trash"></i></button>
                                ...
                                <div class="tab-pane" id="tab_2">
                                  <form action="<?php echo base_url('admin/sirkulasi/insert_kembali');?>" method="POST">
                                    <div class="input-group input-group-sm col-sm-12">
                                       <?php 
                                        ...
                                        <!--<th>Aksi</th>-->
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <!--<td>
                                                <a href="<?php echo base_url('admin/sirkulasi/delete_peminjaman/'.$kem->id_kembali);?>"><button type="button" class="btn btn-danger" onClick="return confirm('Apakah anda yakin ingin menghapus data ini.?')"><i class="fa fa-file"></i></button>
                                              </td>-->
                                            </tr>
                                          <?php endforeach;?>
    ...
    <?php
        ...
        <div class="modal fade" id="modal_ganti<?php echo $ker->id_kerusakan;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url('admin/sirkulasi/pengganti');?>">
                <div class="modal-body">
