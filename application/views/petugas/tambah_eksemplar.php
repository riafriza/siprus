                ...
                <div class="col-md-12">
                  ...
                  <div class="box box-primary">
                    <div class="box-header with-border">
                      <a href="<?php echo base_url('petugas/eksemplar/tambah_eksemplar_cepat');?>"><button class="btn btn-success">Buat Cepat</button></a>
                      <h3 class="box-title">Buat data eksemplar</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" name="random_form" action="<?php echo base_url('petugas/eksemplar/insert_eksemplar');?>" method="POST">
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="id_eksemplar" class="form-control">
                        </div> 
