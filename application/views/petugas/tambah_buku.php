              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" name="random_form" action="<?php echo base_url('petugas/buku/insert_buku');?>" method="POST">
                      <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="tahun" class="form-control" id="exampleInputAlamat1" placeholder="Contoh : Jl. Indramayu No. 45 Indramayu">
                        </div>
                      </div>
                  </div>
                </div>
